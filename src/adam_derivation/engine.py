...
class DerivationEngine:
    ...
    def __init__(self, spec_path: str, sdtm_dir: str, schema_path: Optional[str] = None):
        """
        ...
        self.spec_loader = SpecLoader(str(self.spec_path), str(self.schema_path) if self.schema_path else None)
