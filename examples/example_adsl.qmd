...
## Load Spec 
```{python}
from adam_derivation.loaders import SpecLoader

spec = SpecLoader("../spec/adsl_study1.yaml")

print(spec.domain)
print(spec.keys)
print(spec.columns)
print(spec.get_column_specs("USUBJID"))
print(spec.get_column_specs(["STUDYID", "USUBJID"]))
```